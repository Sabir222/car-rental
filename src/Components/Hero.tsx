const Hero = () => {
  return (
    <div>
      <div className=" flex px-6 sm:px-2 py-4 gap-4 max-w-[1400px] mx-auto">
        <div className="h-[270px] w-[90%] md:w-[100%] bg-gradient-to-r from-cyan-500 to-blue-700 absolute md:static top-[150px] left-6 rounded-2xl p-4">
          <div className="pb-2">
        ...
        <div className="h-[270px] w-[100%] hidden md:block bg-gradient-to-r from-cyan-900 to-blue-300 absolute sm:static top-[150px] left-6 rounded-md p-4">
          <div className="pb-2">
            <h1 className="pb-4 text-lg font-medium text-white">
            ...
            <button className="px-8 py-4 font-medium text-white bg-blue-300 rounded-lg">
              Rental Car
            </button>
          </div>
          <div className="flex justify-center ">
